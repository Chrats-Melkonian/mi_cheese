# Cheese paper figure 4 panel B

# load libs
library(tidyverse)

# load data, join metabolite names and species taxonomy with extracellular fluxes
metnames=read.delim("./mi_cheese/data/Models/data/bigg_classes.tsv",header=TRUE)
species = read.delim("./mi_cheese/data/Models/data/species_names.tsv",header = TRUE)
ex_flux = read.delim("./mi_cheese/data/Models/data/individual_fluxes.tsv",header=TRUE) %>% 
