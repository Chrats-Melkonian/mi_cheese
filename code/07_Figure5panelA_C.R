...
library(viridis)
library(ggplot2)
acid<-read_excel(path = "./mi_cheese/data/T0/Biochemical/190516-004 ACID.xlsx",sheet = "Sheet2")
...
##########################################################
carb<-read_excel(path = "./mi_cheese/data/T0/Biochemical/190520-001 CARB.xlsx",sheet = "Sheet2")
carb<-carb[,c(5,7,9)]
