...
projectName <- "FoodTrans_metaT_milk_OG_3"                         # name of the project
author <- "InKj"                                # author of the statistical analysis/report

targetFile <- "target.txt"                           # path to the design/target file
rawDir <- "OG_count_samples"                                      # path to the directory containing raw counts files
